...
- Особливі категорії вмісту, що описують рідкісні категорії, що поділяються лишень кількома елементами, іноді лише в конкретному контексті.
...
Вміст вбудування – підмножина потокового вмісту, що імпортує інші ресурси чи вставляє в документ вміст з іншої мови розмітки чи простору імен і може використовуватися всюди, де очікується потоковий вміст. Серед елементів, що належать до цієї категорії:
...
### Сценарно-підтримувальні елементи

**Сценарно-підтримувальні елементи** – елементи, котрі безпосередньо не докладаються до зображеного виводу документа. Натомість вони служать підтримкою сценаріям, або вміщаючи, або задаючи код сценаріїв, або вміщаючи дані, котрі будуть використані сценаріями.
...
Коли елемент має модель прозорого вмісту, то його вміст мусить мати таку структуру, що була б дійсним HTML 5, навіть коли прозорий елемент прибирається і заміщається його дочірніми елементами.
