...
| [`expect`](#expect)                                               | Дозволяє сторінці бути [візуалізаційно заблокованою](/uk/docs/Glossary/Render_blocking), поки не розібрано ключові частини документу, щоб візуалізація була послідовною.                                                                                               | Посилання               | Не дозволено                                   | Не дозволено            |
...
- `expect` {{experimental_inline}}
  ...
  - : Дозволяє сторінці бути [візуалізаційно заблокованою](/uk/docs/Glossary/Render_blocking), поки не розібрано ключові частини документу, щоб візуалізація була послідовною. Зверніть увагу на те, що візуалізаційне блокування трапляється лише тоді, коли на нього також вказує атрибут [`blocking="render"`](/uk/docs/Web/HTML/Element/link#blocking).
