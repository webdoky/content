...
Атрибут `autocomplete` надає користувацькому агенту підказку щодо того, як заповнювати форму наперед, і чи треба взагалі це робити. Значення атрибуту може бути ключовим словом `off` або `on`, або списком лексем, розділених пробілами.
