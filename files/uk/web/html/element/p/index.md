...
{{InteractiveExample("Демо HTML: &lt;p&gt;", "tabbed-standard")}}

```html interactive-example
<p>
  Гекони – група зазвичай невеликих, зазвичай нічних плазунів. Вони живуть на
  всіх континентах, окрім Антарктиди.
</p>

<p>
  Частина видів живе в будинках, де вони полюють на комах, приваблених штучним
  світлом.
</p>
```
...
<p>
  ...
  <i>знаком абзацу</i>. Нині він вважається клаустрофобним і нечитабельним.
</p>

<p>
  Наскільки нечитабельним? Дивіться самі:
