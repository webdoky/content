...
- {{htmlattrdef("nomodule")}}
  - : Цей булів атрибут встановлюється, аби вказати, що сценарій не повинен виконуватися в браузерах, що підтримують [модулі ES2015 (англ.)](https://hacks.mozilla.org/2015/08/es6-in-depth-modules/); може використовуватися для надання запасних сценаріїв старішим браузерам, що не підтримують модульний код JavaScript.
- {{htmlattrdef("nonce")}}
...
Браузери, що підтримують значення `module` атрибута {{htmlattrxref("type", "script")}}, ігнорують будь-який сценарій з атрибутом `nomodule`. Це дає змогу використовувати модульні сценарії, на додачу надаючи позначені `nomodule` запасні варіанти сценаріїв для тих браузерів, що не підтримують модулі.
