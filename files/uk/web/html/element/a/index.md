...
- {{HTMLAttrDef("download")}}
  ...
  - : Змушує браузер обробляти заданий URL як завантаження. Може використовуватись як без, так і зі значенням:
    ...
    > - Те, як браузери обробляють завантаження, залежить від браузера, налаштувань користувача та інших чинників. Користувача можуть запитати підтвердження перед початком завантаження, або ж файл може бути збережений автоматично, або ж буде автоматично відкритий, або в зовнішньому застосунку, або в самому браузері.
...
Якщо призначення посилання позначено іконкою, слід пересвідчитись, що ця іконка має {{HTMLAttrxRef("alt", "img", "alt text", "true")}}:
...
- [Хуткий тест: Достатньо великі мішені (англ.)](https://www.a11yproject.com/posts/large-touch-targets/)
...
- {{CSSxRef(":link")}} – псевдоклас CSS, що дає збіг з елементами `<a>`, що мають дійсні атрибути `href`.
