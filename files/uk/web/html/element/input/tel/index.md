...
{{InteractiveExample("Демо HTML: &lt;input type=&quot;tel&quot;&gt;", "tabbed-standard")}}

```html interactive-example
<label for="phone">
  Уведіть свій номер телефону:<br />
...
> [!NOTE]
> Браузери, що не підтримують тип `tel`, відступають до стандартного поля {{HTMLElement("input/text", "text")}}.
...
> [!NOTE]
> Атрибути вище впливають на [валідацію](#validatsiia): введення у прикладі вище вважатиметься недійсним, якщо довжина значення – менша за 9 символів або більша за 14. Більшість браузерів навіть не дозволить ввести значення, довше за максимум.
