...
Поле не пройде [валідацію обмежень](/uk/docs/Web/HTML/Constraint_validation), якщо довжина введеного в нього тексту перевищує `maxlength` кодових одиниць UTF-16. Валідація обмежень накладається лише тоді, коли значення змінює користувач.
...
Поле не пройде [валідацію обмежень](/uk/docs/Web/HTML/Constraint_validation), якщо довжина введеного в нього тексту менша за `minlength` кодових одиниць UTF-16. Валідація обмежень накладається лише тоді, коли значення змінює користувач.
...
> **Примітка:** Використовуйте атрибут [`title`](/uk/docs/Web/HTML/Element/input#title-zaholovok), аби задати текст, котрий більшість браузерів покаже як підказку, що пояснить вимоги для відповідності патернові. Також слід додати поруч іще якийсь пояснювальний текст.
