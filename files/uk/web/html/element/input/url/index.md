...
> **Примітка:** Ці атрибути також впливають на [валідацію](#validatsii); значення, коротші або довші за заданий мінімум чи максимум довжини, вважатимуться недійсними; на додачу до цього, більшість браузерів не дасть ввести значення, довше за задану максимальну довжину.
...
Оскільки поля типу `url` валідуються як за стандартними правилами валідації URL, так і за вказаним [`pattern`](/uk/docs/Web/HTML/Element/input#pattern-patern), ви можете легко реалізувати це. Подивіться, як:
...
Це не ідеально, але достатньо добре для потреб цієї нескладної демонстрації.
...
> **Примітка:** Якщо ви зіткнулися з проблемами під час написання регулярних виразів для валідації, і вони не працюють належним чином, перевірте консоль браузера; там можуть бути корисні повідомлення про помилки, які допоможуть розв'язати проблему.
