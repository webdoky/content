...
2. Один коректно сформований абсолютний URL. Це не обов'язково означає, що адреса URL існує, але вона принаймні коректно відформатована. Запис, що відповідає структурі `urlscheme://restofurl`, може бути валідним навіть тоді, коли введена схема `urlscheme` не існує.
