...
Мінімальна кількість символів (як кодових одиниць UTF-16), котру користувач може ввести в поле `url`. Це повинно бути невід'ємне ціле числове значення, менше або рівне значенню, заданому `maxlength`. Якщо не задано `minlength`, або якщо задано недійсне значення, то таке поле не має мінімальної довжини.
