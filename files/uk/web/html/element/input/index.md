...
<table class="no-markdown">
  <caption>
    Псевдокласи, що стосуються елемента
    <code>&#x3C;input></code>:
  </caption>
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <td>{{Cssxref(":open")}}</td>
      <td>
        Елементи <code>&lt;input&gt;</code>, що показують користувачеві інтерфейс для вибору значення (наприклад, <a href="/uk/docs/Web/HTML/Element/input/color"><code>&lt;input type="color"&gt;</code></a>) – але лише тоді, коли елемент перебуває у відкритому стані, тобто коли показано віконце вибору.
      </td>
    </tr>
  </tbody>
</table>
