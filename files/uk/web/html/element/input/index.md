...
Властивість {{cssxref("field-sizing")}} дає змогу контролювати обчислення розміру формових полів (наприклад, щоб поле усталено отримувало бажаний розмір.) Ця властивість дає змогу відкинути усталену логіку, даючи полям змогу підлаштовуватись, щоб у них вміщався їхній вміст.
