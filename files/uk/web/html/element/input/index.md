...
| [`autocomplete`](#autocomplete)     | майже усі                | Вказівка для функціональності автоматичного заповнення форм                                                        |
...
| [`maxlength`](#maxlength)           | текстові типи            | Найбільша прийнятна довжина (кількість символів) <code>value</code>                                                |
| [`min`](#min)                       | числові типи             | Найменше прийнятне значення                                                                                        |
| [`minlength`](#minlength)           | текстові типи            | Найменша прийнятна довжина (кількість символів) <code>value</code>                                                 |
...
| [`pattern`](#pattern)               | текстові типи            | Схема, котрій мусить відповідати значення <code>value</code>, щоб бути дійсним                                     |
| [`placeholder`](#placeholder)       | текстові типи й `number` | Текст, що з‘являється у контрольному елементі, коли в ньому немає жодного значення                                 |
...
| [`size`](#size)                     | текстові типи            | Розмір контрольного елемента                                                                                       |
