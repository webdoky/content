...
- `autofocus`
  ...
  - : Булів атрибут, котрий, якщо встановлений, вказує, що поле введення повинно автоматично отримати фокус, коли завершилось завантаження сторінки (або коли елемент {{HTMLElement("dialog")}}, що містить таке поле, був показаний).
    ...
    > **Застереження:** Автоматичне фокусування на контрольному елементі може спантеличити людей із порушенням зору, що користуються технологією читання з екрана, а також людей з розумовими порушеннями. Коли встановлено `autofocus`, читачі з екрана без попередження "телепортують" свого користувача до контрольного елемента.
