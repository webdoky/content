...
Наприклад, є низка способів того, як можуть бути ідентифіковані файли Microsoft Word, тому сайт, що приймає файли Word, може використовувати `<input>` такого виду:
...
Незалежно від пристрою чи операційної системи користувача, файлове поле надає кнопку, що відкриває діалог вибору файлу, котра дає користувачеві змогу вибрати файл.
