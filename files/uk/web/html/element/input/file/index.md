...
> [!NOTE]
> Значенням [завжди є ім'я файлу, перед котрим додано `C:\fakepath\`](https://html.spec.whatwg.org/multipage/input.html#fakepath-srsly), що не є справжнім шляхом до файлу. Так зроблено, щоб не дати зловмисним програмам дізнатися про файлову структуру пристрою користувача.
