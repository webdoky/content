...
Поле для галочки, чия властивість `indeterminate` має значення `true`, у більшості браузерів має замість галочки у своїй рамці горизонтальну лінію (щось типу дефіса чи знаку мінуса).
