...
> **Застереження:** Атрибут `tabindex` не повинен використовуватися на елементі `<dialog>`. Дивіться [Примітки щодо застосування](#prymitky-shchodo-zastosuvannia).
...
- Не слід додавати до елемента `<dialog>` властивість `tabindex`, адже не очікується, що цей елемент може отримати фокус. Вміст діалогу, включно зі вміщеною в ньому кнопкою закриття, може отримати фокус та бути інтерактивним.
