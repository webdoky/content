...
- `imagesrcset`
  - : Обмежений `rel="preload"` і `as="image"`, атрибут `imagesrcset` має синтаксис і семантику, подібні до атрибута [`srcset`](/uk/docs/Web/HTML/Element/img#srcset), котрий вказує завантажувати наперед відповідний ресурс, використаний елементом `img`, що має відповідні значення атрибутів `srcset` і `sizes`.
- `integrity`
