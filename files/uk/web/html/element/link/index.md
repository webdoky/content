...
- `fetchpriority`
  ...
  - : Надає підказку щодо відносного пріоритету при отриманні ресурсу певного типу.
    ...
    - `high`
      - : Отримує ресурс з високим пріоритетом відносно інших ресурсів того самого типу.
    - `low`
      - : Отримує ресурс з низьким пріоритетом відносно інших ресурсів того самого типу.
    - `auto`
    ...
    Дивіться більше в {{domxref("HTMLLinkElement.fetchPriority")}}.
...
- `imagesizes`
  - : Обмежений `rel="preload"` і `as="image"`, атрибут `imagesizes` має синтаксис і семантику, подібні до атрибута [`sizes`](/uk/docs/Web/HTML/Element/img#sizes), котрий вказує завантажувати наперед відповідний ресурс, використаний елементом `img`, що має відповідні значення атрибутів `srcset` і `sizes`.
- `imagesrcset`
