...
- {{htmlattrdef("referrerpolicy")}}
  ...
  - : Вказує, якого [посилача](/uk/docs/Web/API/Document/referrer) слід надсилати при отриманні ресурсу фрейму:
    ...
    - `origin-when-cross-origin`: Посилач, надісланий до інших походженнь, буде обмежений схемою, хостом і портом. Переходи в межах того самого походження все ж включатимуть повний шлях.
