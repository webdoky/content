...
- {{htmlattrdef("sandbox")}}
  ...
  - : Накладає на вміст фрейму додаткові обмеження. Значення атрибута може бути або порожнім, щоб застосувати всі обмеження, або розділеними пробілами позначками для зняття певних обмежень:
    ...
    - `allow-popups`: Дозволяє спливні вікна (наприклад, із {{domxref("Window.open()")}}, `target="_blank"`, {{domxref("Window.showModalDialog()")}})). Якщо це ключове слово не застосовано, то ця функціональність непомітно не працюватиме.
