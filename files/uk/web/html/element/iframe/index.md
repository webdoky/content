...
Кожен вбудований навігаційний контекст має власні [історію сесії](/uk/docs/Web/API/History) й [документ](/uk/docs/Web/API/Document). Навігаційний контекст, що вбудовує інші контекст, зветься \*_батьківським_ навігаційним контекстом*. Навігаційний контекст *найвищого рівня\* – той, що не має батьківського – зазвичай є вікном браузера, представленим об'єктом {{domxref("Window")}}.
