    ...
    <tr>
      ...
      <td>
        ...
        <a href="/uk/docs/Web/Guide/HTML/Content_categories#potokovyi-vmist"
          >потоковий вміст</a
        >; не слід використовувати заголовковий елемент як дочірній щодо елемента
        {{HTMLElement("hgroup")}}: тепер це нерекомендовано.
      </td>
    </tr>
    <tr>
...
### Декілька елементів `<h1>` на одній сторінці

Використання більш ніж одного `<h1>` дозволяється специфікацією HTML, але не вважається найкращою практикою. Використання лише одного `<h1>` корисне для користувачів читачів з екрана.

Специфікація HTML містить концепцію _плану_, сформованого шляхом використання елементів {{htmlelement("section")}}.
Якби це було реалізовано, це дало б змогу використовувати декілька елементів `<h1>`, надаючи користувацьким агентам, включно з читачами з екрана, спосіб зрозуміти, що `<h1>`, вкладений у визначений розділ, є підзаголовком. Така функціональність ніколи не була реалізована; таким чином, важливо використовувати заголовки для опису плану документа.

Наступні статті надають більше інформації про стан планів:

- [Комп'ютер відповідає планам HTML5 "ні" (англ.)](https://html5doctor.com/computer-says-no-to-html5-document-outline/)
- [Десятиліття + один рік задом наперед (англ.)](https://html5accessibility.com/stuff/2021/03/21/a-decade-a-year-of-heading-backwards/)
...
Розділення вмісту може отримати підписи завдяки комбінації атрибутів [`aria-labelledby`](/uk/docs/Web/Accessibility/ARIA/Attributes/aria-labelledby) та {{htmlattrxref("id")}}, і такі підписи повинні стисло описувати призначення розділу. Такий підхід корисний в тих ситуаціях, коли на одній сторінці більш ніж один розділовий елемент.
