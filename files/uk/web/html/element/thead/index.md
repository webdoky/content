---
title: <thead> – Елемент заголовку таблиці
...
- `valign` {{deprecated_inline}}
  ...
  - : Задає вертикальне вирівнювання кожної комірки заголовку. Можливі значення {{Glossary("enumerated", "перелічені")}}: `baseline`, `bottom`, `middle` і `top`. Натомість слід використовувати властивість CSS {{cssxref("vertical-align")}}, оскільки цей атрибут є нерекомендованим.
...
Трохи базового CSS вжито для стилізації та виділення заголовку таблиці, щоб заголовки стовпців виділялися серед даних у тілі таблиці.
...
{{EmbedLiveSample("bazova-struktura-zaholovku", 650, 140)}}

### Кілька рядів заголовку

Цей приклад демонструє розділ заголовку таблиці з двома рядами.
...
- {{cssxref("background-color")}} – властивість CSS для задання кольору фону кожної комірки-заголовку
- {{cssxref("border")}} – властивість CSS для контролю меж комірок-заголовків
- {{cssxref("text-align")}} – властивість CSS для горизонтального вирівнювання вмісту кожної комірки-заголовку
- {{cssxref("vertical-align")}} – властивість CSS для вертикального вирівнювання вмісту кожної комірки-заголовку
