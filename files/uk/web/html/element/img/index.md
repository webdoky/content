...
- `fetchpriority`
  ...
  - : Надає підказку щодо відносного пріоритету при отриманні зображення.
    Дозволені значення:
  ...
  Дивіться більше в {{domxref("HTMLImageElement.fetchPriority")}}.
