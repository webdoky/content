...
Якщо помилка трапляється при завантаженні чи візуалізації зображення, і якщо був встановлений обробник помилки {{htmlattrxref("onerror")}} для події {{domxref("Element/error_event", "error")}}, то такий обробник помилки буде викликаний. Це може статися в низці ситуацій, в тому числі:
