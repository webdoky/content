...
- [`autocapitalize`](/uk/docs/Web/HTML/Global_attributes/autocapitalize)
  ...
  - : Контролює те, чи буде, і якщо буде, то як, текстове введення автоматично отримувати великі літери при введенні чи редагуванні користувачем. Може мати наступні значення:

    - `off` або `none`, великі літери автоматично не додаються (всі літери усталено нижнього регістру)
    - `on` або `sentences`, перша літера кожного речення усталено стає великою; всі решта літер усталено нижнього регістру
    - `words`, перша літера кожного слова усталено велика; всі решта літер усталено нижнього регістру
    - `characters`, усі літери повинні усталено бути верхнього регістру
