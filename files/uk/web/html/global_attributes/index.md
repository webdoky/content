...
- [`anchor`](/uk/docs/Web/HTML/Global_attributes/anchor) {{non-standard_inline}}
  - : Пов'язує позиційований елемент з якірним елементом. Значення атрибута – це значення [`id`](/uk/docs/Web/HTML/Global_attributes/id), до якого прив'язаний позиційований елемент. Цей елемент потім може бути позиційований [за допомогою якірного позиціювання CSS](/uk/docs/Web/CSS/CSS_anchor_positioning/Using).
...
- [`contenteditable`](/uk/docs/Web/HTML/Global_attributes/contenteditable)
  ...
  - : [Перелічуваний](/uk/docs/Glossary/Enumerated) атрибут, що вказує, чи повинен елемент бути редагованим з боку користувача. Якщо так, то браузер видозмінює його віджет, аби дозволити редагування. Атрибут повинен приймати одне з наступних значень:
    ...
    - `plaintext-only, що вказує на те, що необроблений текст елемента придатний для редагування, але багаті можливості з форматування тексту – вимкнені.
