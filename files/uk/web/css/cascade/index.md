...
Коли ваш вміст завершив змінювати стилі, можна опинитися в ситуації, коли необхідно повернути їх до якогось відомого стану. Це може статися в випадку анімацій, змін теми і так далі. Властивість CSS {{cssxref("all")}} дає змогу швидко повернути (майже) все в CSS до відомого стану.
