...
Властивість [CSS](/en-US/docs/Web/CSS) **`font-size`** встановлює розмір шрифту. Зміна розміру шрифту також змінює розміри одиниць вимірювання {{cssxref("&lt;length&gt;")}}, залежних від розміру шрифту, наприклад, `em`, `ex`, і так далі.
...
- У вигляді одного із ключових слів абсолютного розміру чи відносного розміру
- У вигляді значення `<length>`, або відносного від розміру шрифту елемента `<percentage>`.

### Значення

- `xx-small`, `x-small`, `small`, `medium`, `large`, `x-large`, `xx-large`, `xxx-large`
  - : Ключові слова абсолютного розміру, засновані на усталеному розмірі шрифту користувача (котрий тут відповідає `medium`).
- `larger`, `smaller`
...
Використання значення `em` створює динамічний (обчислений) розмір шрифту (історично одиниця вимірювання `em` походить від ширини літери "M" у певній гарнітурі.). Числове значення діє як множник властивості `font-size` елемента, на котрому застосоване. Погляньмо на наступний приклад:
