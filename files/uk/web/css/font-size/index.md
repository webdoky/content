...
- `math`
    Мають бути застосовані собливі [правила математичного масштабування](https://w3c.github.io/mathml-core/#the-math-script-level-property) при визначенні обчисленого значення властивості `font-size`.
