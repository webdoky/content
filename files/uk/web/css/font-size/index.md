...
- `math`
  - : При визначенні обчисленого значення властивості `font-size` застосовуються особливі [правила математичного масштабування](https://w3c.github.io/mathml-core/#the-math-script-level-property).
