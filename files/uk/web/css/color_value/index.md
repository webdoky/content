...
- За допомогою системи [кубічних координат](https://en.wikipedia.org/wiki/RGB_color_model#Geometric_representation) (#-шістнадцятковим записом або функційним записом `rgb()`).
  Цей варіант завжди задає колір у [кольоровому просторі sRGB](https://uk.wikipedia.org/wiki/SRGB).
- За допомогою системи [циліндричних координат HSL](https://uk.wikipedia.org/wiki/HSL) (функційного запису {{cssxref("color_value/hsl","hsl()")}}).
  Цей варіант завжди задає колір у [кольоровому просторі sRGB](https://uk.wikipedia.org/wiki/SRGB).
...
> **Примітка:** Історичний запис {{cssxref("color_value/hsla", "hsla()")}} є псевдонімом `hsl()`, приймає такі ж параметри та поводиться так само.
