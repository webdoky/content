...
- За допомогою [системи координат Lab](https://uk.wikipedia.org/wiki/Lab), функційним записом {{cssxref("color_value/lab","lab()")}}.
  Цей варіант може задати будь-який видимий колір.
- За допомогою функційного запису {{cssxref("color_value/color","color()")}}, аби задати колір в одному з багатьох наперед визначених або власному кольоровому просторі.
...
Кольори RGB можуть бути виражені як шістнадцятковим (з префіксом `#`), так функційним (`rgb()`, `rgba()`) записами.
...
- Частина загальновживаних властивостей, котрі використовують цей тип даних: {{Cssxref("color")}}, {{Cssxref("background-color")}}, {{Cssxref("border-color")}}, {{Cssxref("box-shadow")}}, {{Cssxref("outline-color")}}, {{Cssxref("text-shadow")}}
