...
Числові значення `100` й `900` приблизно відповідають наступним загальноприйнятим іменам ваг (дивіться [Специфікацію OpenType (англ.)](https://docs.microsoft.com/typography/opentype/spec/os2#usweightclass)):
