...
> **Примітка:** Ці одиниці, особливо `em` і `rem`, нерідко використовуються для створення масштабованих макетів, котрі зберігають [вертикальний ритм сторінки](https://24ways.org/2006/compose-to-a-vertical-rhythm) навіть тоді, коли користувач змінює розмір шрифту.
