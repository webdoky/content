...
- Задання одного напрямку зі значенням `visible` (усталеним), а іншого з _інакшим_ значенням – призводить до того, що `visible` поводиться як `auto`.
- Задання одного напрямку зі значенням `clip`, а іншого з _інакшим_ значенням – призводить до того, що `clip` поводиться як `hidden`.
