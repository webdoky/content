...
- [Основи стилізації CSS](/uk/docs/Learn_web_development/Core/Styling_basics)
  - : Модуль Основ CSS нашого розділу [Навчання веброзробки](/uk/docs/Learn_web_development) вчить основам CSS з самого початку.
...
- [Компонування CSS](/uk/docs/Learn_web_development/Core/CSS_layout)
  - : Тепер час розглянути те, як правильно розкласти рамки відносно одна одної та області перегляду браузера. Цей модуль розглядає пливуни, позиціювання, інші сучасні інструменти компонування та створення чуйних дизайнів, які адаптуються до різних пристроїв, розмірів екрану та роздільної здатності.
