...
4. Коли властивість `position` має значення **`absolute`** або **`fixed`**, контейнерний блок так само буде бути утворений краєм _рамок внутрішніх відступів_ найближчого елемента-предка, котрий виконує наступні умови:
...
Як зазначено вище, коли певні властивості отримують відсоткове значення, то обчислене значення залежить від контейнерного блока елемента. Властивості, котрі так працюють – **властивості рамкової моделі** та **властивості відступу**:
