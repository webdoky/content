...
> [!NOTE]
> Всі важливі оголошення мають пріоритет над усіма анімаціями. Позначка `!important` не є дійсною в межах оголошень [анімацій @keyframes](/uk/docs/Web/CSS/@keyframes).
