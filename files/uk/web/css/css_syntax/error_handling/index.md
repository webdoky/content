...
> [!NOTE]
> Слід уникати властивостей чи їх значень з префіксами, коли це можливо. Якщо їх все ж необхідно використати, слід оголошувати версії з префіксами перед версією без префіксів, як показано вище.
...
> [!NOTE]
> Це істинно для зовнішніх списків стилів, блоків селекторів усередині елемента HTML {{HTMLElement("style")}} та вбудованих правил в атрибуті [`style`](/uk/docs/Web/HTML/Global_attributes/style).
