...
![Діаграма Венна інструкцій, яка позначає те, що вмі набори правил є вкладеними інструкціями, натомість частина директив є вкладеними інструкціями, але не всі. Все, що не є ані директивою, ані вкладеним – є невалідним.](css_syntax_-_statements_venn_diag.png)
