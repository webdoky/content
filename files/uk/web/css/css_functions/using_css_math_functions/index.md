...
В цілому розробники можуть скористатися поєднанням [більш ніж двох десятків математичних функцій CSS](/uk/docs/Web/CSS/CSS_Functions#matematychni-funktsii) у своїх списках стилів. У цьому посібнику вводяться чотири з найбільш поширених, а також більш складні.
...
Є випадки, коли ми не хочемо, щоб значення властивості CSS перевищувало певне число. Скажімо, наприклад, хочемо, щоб ширина контейнера вмісту була меншою поміж "повної ширини нашого екрану" та "500 пікселів". У таких випадках можна скористатися математичною функцією CSS {{CSSxRef("min", "min()")}}.
...
Аналогічно до `min()`, іноді ми не хочемо, щоб значення властивості CSS не досягало певного числа. Наприклад, можемо хотіти, щоб ширина контейнера вмісту була _більшим значенням_ серед "повної ширини нашого екрану" і "500 пікселів". У таких випадках можна скористатися математичною функцією CSS {{CSSxRef("max", "max()")}}.
...
- [Тригонометричні функції](/uk/docs/Web/CSS/CSS_Functions#tryhonometrychni-funktsii)
  ...
  - {{CSSxRef("acos", "acos()")}} – обчислює **тригоноетричний арккосинус** числа
  - {{CSSxRef("atan", "atan()")}} – обчислює **тригоноетричний арктангенс** числа
