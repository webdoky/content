...
Якщо створити запит на ознаку медіа, не вказуючи значення, то вкладені стилі будуть використовуватись, поки значення ознаки не рівне нулю (або, на [Рівні 4](https://drafts.csswg.org/mediaqueries-4/), `none`).
