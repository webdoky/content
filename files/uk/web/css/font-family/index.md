...
Властивість [CSS](/uk/docs/Web/CSS) **`font-family`** (сімейство шрифту) встановлює для обраного елемента список за пріоритетом з одного або кількох імен сімейств шрифту та (або) загальних сімейств.
