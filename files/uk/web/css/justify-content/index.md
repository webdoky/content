...
justify-content: space-around; /* Розподілити елементи рівномірно
                                  Елементи займають половину доступного простору
                                  з обох кінців */
...
- `space-around`
  - : Елементи рівномірно розподілені в межах контейнера шикування вздовж головної осі. Проміжки між кожними двома сусідніми елементами – однакові. Незайнятий простір між перед першим та після останнього елемента дорівнює половині простору між кожними двома сусідніми елементами.
- `space-evenly`
