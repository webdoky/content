...
> **Примітка:** Імена кастомних властивостей є чутливими до регістру: `--my-color` вважатиметься окремою кастомною властивістю поруч із `--My-color`.
...
> **Примітка:** Запасні значення не використовуються для виправлення проблем сумісності, коли кастомні властивості CSS не підтримуються, оскільки запасне значення не допоможе в такому випадку.
