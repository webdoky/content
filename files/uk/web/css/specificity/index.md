...
Специфічність псевдокласу припасування специфічності {{CSSxRef(":where", ":where()")}} завжди зводиться до нуля, `0-0-0`. Це дає змогу робити селектори CSS украй конкретними щодо того, з якими елементами вони дають збіг, без збільшення їх специфічності.
