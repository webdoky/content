...
Комбінатор вкладеності `&` не додає ваги специфічності, а вкладені правила навпаки – додають. Що до специфічності та функціональності, то вкладеність вельми подібна до псевдокласу {{CSSxRef(":is", ":is()")}}.
