...
3.  У якості безглуздого особливого випадку для (2), продублюйте прості селектори, аби збільшити специфічність, коли немає більше куди звужувати специфічність.
...
B) Або додаймо такий же селектор після існуючого:
...
Специфічність заснована на формі селектора. У наступному випадку селектор `*[id="foo"]` враховується як селектор атрибута при визначенні специфічності селектора, незважаючи на те, що він обирає за ідентифікатором.
...
Причина цього &mdash; у тому, що два оголошення мають однакові суми [за типами селекторів](#selector_types), але втім, селектор `html h1` оголошений останнім.

### Напряму цільові елементи проти наслідуваних стилів

Стилі для напряму цільового елемента мають перевагу над наслідуваними стилями, незалежно від специфічності наслідуваного правила. Цей CSS-код...
