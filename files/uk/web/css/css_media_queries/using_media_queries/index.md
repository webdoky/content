...
Специфікація "Медіазапити, рівень 4" включає певні покращення синтаксису, покликані зробити медіазапити з використанням ознак типу діапазону, наприклад, висоти чи ширини, менш багатослівними.
Рівень 4 додає _контекст діапазону_ для написання таких запитів.
Подробиці щодо підтримки цього можна перевірити в [таблиці сумісності з браузерами для `@media`](/uk/docs/Web/CSS/@media#sumisnist-iz-brauzeramy).

Щоб побачити, як працює синтаксис "діапазону", розглянемо приклад, що застосовує стилі на основі `max-width`:
...
За допомогою синтаксису "діапазону" це можна переписати так:
