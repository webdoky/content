...
Проте одне важливе перетворення не є лінійним, а отже – повинно мати особливий випадок при застосуванні такого запису: переклад. Вектор перекладу `(tx, ty)` повинен бути виражений окремо, як два додаткові параметри.
...
Наступний приклад містить тривимірний куб, створений з елементів DOM і перетворень, а також меню вибору, яке дає змогу вибрати різні функції перетворення для перетворення куба, щоб порівняти вплив різних типів.
