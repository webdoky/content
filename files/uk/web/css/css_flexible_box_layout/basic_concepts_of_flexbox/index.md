...
Розуміння значення кожної з осей важливе для початку розгляду шикування та вирівнювання гнучких елементів; флексбокс пропонує властивості, що шикують та вирівнюють вміст відносно тієї чи тієї осі.
...
У статті [Шикування елементів у гнучкому контейнері](/uk/docs/Web/CSS/CSS_Flexible_Box_Layout/Aligning_Items_in_a_Flex_Container) ці властивості досліджуються із більшим заглибленням, аби отримати краще розуміння їх роботи. Втім, у більшості випадків будуть корисними і наведені вище прості приклади.
