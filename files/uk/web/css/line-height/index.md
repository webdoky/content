...
Властивість [CSS](/uk/docs/Web/CSS) **`line-height`** (висота строю) задає висоту рамок строю. Вона загальновживана для задання відстані між рядками тексту. Для елементів блокового рівня вона задає мінімальну висоту рамок строю всередині елемента. Для не[заміщених](/uk/docs/Web/CSS/Replaced_element) рядкових елементів вона задає висоту, котра використовується для обчислення висоти рамок строю.
