...
1. Їх легко застосовувати для простих анімацій; їх можна створювати навіть без потреби знати JavaScript.
...
У цьому, другому прикладі, задаються три імені анімацій, але є лише одна тривалість й одна кількість ітерацій. В такому випадку всі три анімації отримують однакові тривалість і кількість анімацій.
...
> **Примітка:** Частина старих браузерів (до 2017 року) могли потребувати префіксів; жваві приклади, котрі для перегляду треба клацнути, включають синтаксис із префіксом `-webkit`.
...
Зверніть увагу, що анімації штибу цієї можуть призвести до того, що сторінка стане ширшою за вікно браузера. Аби цього уникнути цієї проблеми, слід помістити анімований у контейнер, і цьому контейнеру задати {{cssxref("overflow")}}`:hidden`.
...
Щоб анімація повторювалася, треба додати властивість {{cssxref("animation-iteration-count")}}, котра вказує на те, скільки разів треба повторити анімацію. В цьому випадку використаймо `infinite`, аби анімація повторювалася нескінченно:
