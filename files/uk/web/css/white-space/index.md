...
- Чи [перекриваються](#perekryttia-probiliv), і якщо перекриваються, то як, пробіли.
- Чи може шеренга символів розірватись у точці потенційного м'якого розриву.
...
- `normal`
  - : Кілька пробілів підряд – [перекриваються](#perekryttia-probiliv). Символи нового рядка у вихідному коді обробляються як додаткові пробіли. Шеренги символів розриваються так, як необхідно для заповнення рядкових рамок.
- `nowrap`
