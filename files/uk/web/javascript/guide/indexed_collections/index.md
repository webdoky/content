...
Метод {{jsxref("Object.groupBy()")}} може використовуватися для групування елементів масиву, за допомогою перевіркової функції, що повертає рядок, що позначає групу для поточного елемента.
