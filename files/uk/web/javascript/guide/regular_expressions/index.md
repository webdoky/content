...
Це пояснено в деталях нижче, в розділі [Поглиблений пошук з прапорцями](#pohlyblenyi-poshuk-z-praportsiamy).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Індекс, з якого почнеться пошук наступного збігу.
        ...
        <a href="#pohlyblenyi-poshuk-z-praportsiamy">Поглиблений пошук з прапорцями</a>.)
      </td>
      <td><code>5</code></td>
    </tr>
    <tr>
...
### Поглиблений пошук з прапорцями
