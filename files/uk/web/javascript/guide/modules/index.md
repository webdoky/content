...
[Карти імпортування](/uk/docs/Web/HTML/Element/script/type/importmap) дають розробникам змогу натомість задати майже будь-який текст, який завгодно, у модульному специфікаторі при імпорті модуля; карта надає відповідне значення, котре замінить текст при розв'язанні URL модуля.
