...
У JavaScript функція може бути визначена на основі умови. Наприклад, наступне визначення функції визначає `myFunc` лише за умови, що `num` дорівнює `0`:
...
Усе може бути складніше, ніж у коді вище. Об'єкт, що містить методи для роботи з внутрішніми змінними зовнішніх функцій, може бути повернений.
...
> **Примітка:** There are a number of pitfalls to watch out for when using closures!
>
...
- {{jsxref("Global_Objects/isNaN", "isNaN()")}}
  - : Функція **`isNaN()`** з'ясовує, чи є значення {{jsxref("Global_Objects/NaN", "NaN")}}. Примітка: зведення типів усередині функції `isNaN` має [цікаві](/uk/docs/Web/JavaScript/Reference/Global_Objects/isNaN#opys) правила; інший варіант – використати для з'ясування, чи є значення нечислом, {{jsxref("Number.isNaN()")}}.
