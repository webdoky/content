...
В старі часи виконання декількох асинхронних операцій по черзі призводило до класичної піраміди функцій зворотного виклику загибелі:
...
Проміси розв'язують фундаментальну проблему з пірамідою функцій зворотного виклику загибелі, перехоплюючи всі помилки, навіть викинуті винятки й помилки програмування. Це критично для функційної композиції асинхронних операцій.
...
Досвід підказує, що слід завжди або повертати, або закривати ланцюжки промісів, і щойно отримано новий проміс, його слід негайно повертати, щоб усе сплостити:
