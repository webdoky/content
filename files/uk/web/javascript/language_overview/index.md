...
- На основі функцій зворотного виклику (як то {{domxref("Window.setTimeout", "setTimeout()")}})
- На основі {{jsxref("Global_Objects/Promise", "Promise")}}
- {{jsxref("Statements/async_function", "async")}} і {{jsxref("Operators/await", "await")}}, що є синтаксичним цукром для Promise
...
Також JavaScript описує модульну систему, котра підтримується більшістю середовищ виконання. Модуль – це зазвичай файл, котрий ідентифікується шляхом до себе, або URL. Інструкції {{jsxref("Statements/import", "import")}} і {{jsxref("Statements/export", "export")}} можна використовувати для обміну даними між модулями:
