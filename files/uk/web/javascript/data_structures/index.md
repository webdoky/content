...
Рядки JavaScript є незмінними. Це означає, що відколи рядок створений, його неможливо змінити. Методи рядка створюють нові рядки на основі вмісту поточного рядка – наприклад:
