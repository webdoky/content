...
JavaScript є _слабко типізованою_ та _динамічною_ мовою. Змінні в JavaScript не пов'язані напряму з жодним конкретним типом даних, і будь-якій змінній можуть бути присвоєні (й присвоєні знову) значення всіх типів:
...
- `set`
  - : Функція, що викликається з аргументом, котрий містить присвоюване значення. Виконується щоразу, коли відповідну властивість намагаються змінити. Більше – на сторінці [сеттерів](/uk/docs/Web/JavaScript/Reference/Functions/set). Може мати значення `undefined`.
- `enumerable`
