...
Замикання також можуть замикатися над імпортованими значеннями, котрі вважаються _живими зв'язуваннями_, адже коли змінюється початкове значення, відповідно змінюються значення імпортовані.
