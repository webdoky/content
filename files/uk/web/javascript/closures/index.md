...
Ці три публічні функції є замиканнями, що поділяють одне лексичне оточення. Завдяки лексичному охопленню JavaScript кожна з них має доступ до змінної `privateCounter` і функції `changeBy`.
...
Замикання також можуть замикатися над імпортованими значеннями, котрі вважаються _живими зв'язуваннями_, адже коли змінюється початкове значення, відповідно змінюються й імпортовані значення.
