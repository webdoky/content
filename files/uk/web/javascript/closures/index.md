...
**Замикання** – поєднання функції, зчепленої вкупі з (замкненої на) посиланням на стан, що її оточує (**лексичне оточення**). Інакше кажучи, замикання надає функції доступ до області видимості навколо неї. У JavaScript замикання породжуються щоразу, коли створюється функція, під час її створення.
...
Звичаєво (до ES6) змінні JavaScript мали лише два види областей видимості: _область функції_ та _глобальну область_. Змінні, оголошені з `var`, обмежені або функцією, або глобальною областю, залежно від того, де вони оголошені: всередині функції чи поза функцією. Це може бути мудрованим, адже блоки з фігурними дужками не породжують областей видимості:
...
> [!NOTE]
> Використання замикань у такий спосіб надає переваги, що зазвичай пов'язуються з об'єктноорієнтованим програмуванням. А саме – _приховування даних_ та _інкапсуляція_.

## Ланцюжок областей видимості замикань

Вкладена функція має доступ до області видимості зовнішньої функції, включно з областю видимості зовні цієї самої зовнішньої функції – так утворюється ланцюжок областей видимості функцій. Дивіться демонстрацію в коді прикладу нижче.
...
У прикладі вище – низка вкладених функцій, кожна з яких має доступ до області зовнішніх функцій. У такому контексті можна сказати, що замикання мають доступ до _всіх_ зовнішніх областей видимості.
