...
> **Зауваження:** Класові **вирази** повинні бути оголошені до того, як їх можна буде використовувати (вони підпорядковуються таким самим правилам підняття, які описано в розділі [Оголошення класів](#oholoshennia-klasiv)).
