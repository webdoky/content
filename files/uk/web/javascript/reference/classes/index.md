...
Інший варіант: якщо значення властивостей примірника не залежать від аргументів конструктора, то їх можна означувати як [поля класу](#oholoshennia-publichnykh-poliv).
...
За допомогою синтаксису оголошення полів класу приклад [constructor](#konstructor) може бути переписаний так:
