...
| U+FEFF       | Маркер порядку байтів       | \<BOM>      | Використовується на початку сценарію, аби позначити його як Unicode, а також щоб дати змогу визначити кодування та порядок байтів тексту ([Вікіпедія](https://uk.wikipedia.org/wiki/%D0%9C%D0%B0%D1%80%D0%BA%D0%B5%D1%80_%D0%BF%D0%BE%D1%80%D1%8F%D0%B4%D0%BA%D1%83_%D0%B1%D0%B0%D0%B9%D1%82%D1%96%D0%B2)). |
