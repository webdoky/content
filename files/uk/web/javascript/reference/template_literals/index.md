...
Усталена функція просто з'єднує передані частини у цілий рядок. Якщо перед шаблонним літералом знаходиться якийсь вираз (як от `tag`) — це називається **тегованим шаблоном**. В такому разі, вираз тегу (зазвичай функція) викликається разом з шаблонним літералом, з яким після цього можна виконувати якісь дії — перед тим, повернути з функції.
...
В деяких випадках, вкладання шаблону — це найпростіший (і, ймовірно, зручніший для читання) спосіб отримання рядків, які можна налаштовувати. Всередині шаблону, виділеного тупими наголосами, можна уможливити внутрішній шаблон, просто вживши його всередині поля для заповнення `${ }` в шаблоні.
...
Від ECMAScript 2016, теговані шаблони враховують правила таких екранованих послідовностей:
...
Це означає, що буде проблематичним вжити таки тегований шаблон, як наведено нижче, оскільки, згідно з граматикою ECMAScript, парсер шукатиме дійсну екрановану послідовність Unicode, але знайде дефектний синтаксис:
...
Теговані шаблони повинні давати змогу вкладати інші мови (наприклад [предметно орієнтовані](https://en.wikipedia.org/wiki/Domain-specific_language), чи [LaTeX](https://en.wikipedia.org/wiki/LaTeX)), в яких поширені інші екрановані послідовності. Пропозиція до розгляду ECMAScript під назвою [Перегляд шаблонних літералів (англ.)](https://tc39.github.io/proposal-template-literal-revision/) (Стадія 4, до інтеграції в стандарт ECMAScript 2018) прибирає обмеження екранованих послідовностей ECMAScript з тегованих шаблонів.

Все ж, недійсні екрановані послідовності все одно необхідно показати в “приготовленому” виразі. Їх буде показано як {{jsxref("undefined", "невизначені")}} елементи в масиві “cooked”:
