...
- `стрічка тексту`
  - : Рядок, що стане частиною шаблонного літерала. Майже всі символи дозволені в буквальному вигляді, включно з [розривами рядка](/uk/docs/Web/JavaScript/Reference/Lexical_grammar#kinets-riadka) та іншими [пробільними символами](/uk/docs/Web/JavaScript/Reference/Lexical_grammar#probil). Проте недійсні екрановані послідовності призведуть до синтаксичної помилки, якщо не використана [тегова функція](#tehovani-shablony-i-ekranovani-poslidovnosti).
- `вираз`
...
За відсутності шаблонних літералів, коли є потреба скомбінувати вивід виразу із рядками, знадобилося б [з'єднати їх](/uk/docs/Learn/JavaScript/First_steps/Strings#ziednannia-za-dopomohoiu) за допомогою [оператора додавання](/uk/docs/Web/JavaScript/Reference/Operators/Addition) `+`:
...
Зверніть увагу, що ці два вирази усе ж є розбірливими. Це означає, що вони не будуть піддані [автоматичному доданню крапки з комою](/uk/docs/Web/JavaScript/Reference/Lexical_grammar#avtomatychne-dodannia-krapky-z-komoiu), котре додає крапку з комою для виправлення коду, котрий без цього є нерозбірливим.
...
У звичайних шаблонних літералах дозволені усі [екрановані послідовності рядкових літералів](/uk/docs/Web/JavaScript/Reference/Global_Objects/String#ekranovani-poslidovnosti). Будь-які інші погано сформовані екрановані послідовності є синтаксичною помилкою. Серед них:

- `\`, після якої – будь-яка десяткова цифра, крім `0`, або `\0` з десятковою цифрою опісля; наприклад, `\9` і `\07` (що є [нерекомендованим синтаксисом](/uk/docs/Web/JavaScript/Reference/Deprecated_and_obsolete_features#ekranovani-poslidovnosti))
