...
**Вираз стрілкової функції** — це компактна альтернатива традиційному [функціональному виразові](/en-US/docs/Web/JavaScript/Reference/Operators/function), яку, проте, можна використовувати не у всіх випадках через певні обмеження.
...
Як було вказано раніше, вирази стрілкових функцій найкраще підходять для функцій, які не є методами. Давайте подивімося, що трапиться, коли ми все ж таки спробуємо використати таку функцію як метод:
...
// Встановлення "num" на об'єкті window щоб проілюструвати, що воно НЕ використовується.
window.num = 2020; // йой!

// Проста традиційна функція, яка оперує з "this"
...
Зі стрілковою функцією, оскільки наша функція `add` створена в контексті об'єкта `window` (глобальному контексті), вона вважатиме, що `this` і є `window`.
...
В більшості випадків, застосування [залишкових параметрів](/en-US/docs/Web/JavaScript/Reference/Functions/rest_parameters) є хорошою альтернативою використанню об'єкта `arguments`.
