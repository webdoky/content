...
Стрілкові функції самі по собі не пов'язуються з жодними іменами. Якщо стрілковій функції треба викликати саму себе, слід натомість використовувати іменований вираз функції. Крім цього, можна присвоїти стрілкову функцію змінній, що дає змогу звертатися до цієї функції через цю змінну.
