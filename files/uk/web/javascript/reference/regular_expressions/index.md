...
- `\$`, `\(`, `\)`, `\*`, `\+`, `\.`, `\/`, `\?`, `\[`, `\\`, `\]`, `\^`, `\{`, `\|`, `\}`: дійсно завжди
- `\-`: дійсно лише всередині [класів символів](/uk/docs/Web/JavaScript/Reference/Regular_expressions/Character_class)
- `\!`, `\#`, `\%`, `\&`, `\,`, `\:`, `\;`, `\<`, `\=`, `\>`, `\@`, `` \` ``, `\~`: дійсно лише всередині [класів символів режиму `v`](/uk/docs/Web/JavaScript/Reference/Regular_expressions/Character_class#klas-symvoliv-rezhymu-v)
