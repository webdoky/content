...
> [!NOTE]
> Регулярні вирази JavaScript насправді не є регулярними, через існування [зворотних посилань](/uk/docs/Web/JavaScript/Reference/Regular_expressions/Backreference) (регулярні вирази повинні мати скінченну кількість станів). Однак вони все одно є дуже корисною можливістю.
...
Позначки `i`, `m` і `s` можна вмикати та вимикати для конкретних частин регулярного виразу за допомогою синтаксису [модифікатора](/uk/docs/Web/JavaScript/Reference/Regular_expressions/Modifier).
...
- [Модифікатор – `(?ims-ims:...)`](/uk/docs/Web/JavaScript/Reference/Regular_expressions/Modifier)
...
- `\!`, `\#`, `\%`, `\&`, `\,`, `\:`, `\;`, `\<`, `\=`, `\>`, `\@`, `` \` ``, `\~`: валідні лише всередині [класів символів режиму `v`](/uk/docs/Web/JavaScript/Reference/Regular_expressions/Character_class#klas-symvoliv-rezhymu-v)
