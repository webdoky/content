...
Як і у випадку інших інструкцій циклів, всередині `statement` можна користуватися [інструкціями керування плином виконання](/uk/docs/Web/JavaScript/Reference/Statements#keruvannia-plynom-vykonannia):
