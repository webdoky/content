...
> **Зауваження:** Категорично не рекомендується розбирати властивості дати за допомогою конструктора `Date` (і `Date.parse`, що еквівалентно) у зв‘язку з відмінностями та неузгодженістю в реалізаціях браузерів.
