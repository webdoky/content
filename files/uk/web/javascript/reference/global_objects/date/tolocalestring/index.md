...
### Слід уникати порівняння відформатованих значень дати зі статичними значеннями

У більшості випадків, форматування, повернене `toLocaleString()`, є сталим. Проте воно може змінитися з часом, і немає гарантій для усіх мов; варіації виведення закладені свідомо і дозволені специфікацією.

Перш за все, браузери IE та Edge вставляють навколо дат двонапрямлені контрольні символи, щоб текст виведення коректно вписувався при комбінуванні з іншим текстом.

Через це не можна розраховувати на змогу порівняти результат `toLocaleString()` зі статичним значенням:

```js example-bad
"1/1/2019, 01:00:00" ===
  new Date("2019-01-01T01:00:00Z").toLocaleString("en-US");
// true у Firefox і решті
// false в IE та Edge
```

> **Примітка:** Більше подробиць та прикладів на додачу – у цьому [треді на StackOverflow](https://stackoverflow.com/questions/25574963/ies-tolocalestring-has-strange-characters-in-results).
