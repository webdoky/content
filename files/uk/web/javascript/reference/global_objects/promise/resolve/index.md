...
> [!WARNING]
> Не слід викликати `Promise.resolve()` на очікуваному об'єкті, що вміщає самого себе як значення вирішення. Це призводить до нескінченної рекурсії, адже намагається сплощити проміс нескінченної вкладеності.
