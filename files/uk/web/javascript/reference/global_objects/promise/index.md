...
Про проміс кажуть, що він _залагоджений_, якщо він або сповнився, або відхилився, але не перебуває в стані очікування. Його стан такої миті також звуть _кінцевим станом_, котрий може бути або "сповнений певним значенням", або "відхилений з певної причини".
...
Щоб взаємодіяти з наявними реалізаціями Promise, мова дозволяє використання очікуваних замість промісів. Наприклад, [`Promise.resolve`](/uk/docs/Web/JavaScript/Reference/Global_Objects/Promise/resolve) вирішить не лише проміси, а й відстежить очікуваних.
...
Promise.resolve(aThenable); // Проміс сповнюється 42
```
