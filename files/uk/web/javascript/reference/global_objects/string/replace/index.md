...
Наступний скрипт міняє слова місцями в рядку. Для отримання тексту заміни, скрипт використовує [групи з захопленням](/uk/docs/Web/JavaScript/Guide/Regular_Expressions/Groups_and_Ranges) і патерни заміни `$1` та `$2`.
