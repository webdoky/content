...
Об'єкт **`String`** — «Рядок», «Стрічка» — використовується для представлення та обробки послідовностей символів.
...
Або ж можна використати обернену скісну риску (`\`) в кінці кожного рядка, аби позначити, що стрічка продовжується на наступному рядку. Обов'язково слід впевнитись, що після скосу немає пробілу чи якихось інших символів (окрім перенесення на новий рядок), або відступів, інакше такий запис працювати не буде.
