...
Заморожений об'єкт стає _імутабельним_. Проте, це не обов'язково означає _сталий_. Наступний приклад ілюструє, що заморожений об'єкт не є сталим(тобто, замороження є поверхневим).
