...
Копіюються властивості, що мають ключами як {{jsxref("String")}}, так і {{jsxref("Symbol")}}.
...
### Не можливо скопіювати властивості в прототипному ланцюжку чи неперелічувані властивості
...
console.log(target.foo);  // 1, тут кикинуто виняток.
console.log(target.foo3); // undefined, робота методу "assign" завершилася, foo3 скопійовано не буде.
console.log(target.baz);  // undefined, третій донор такж копіюватися не буде.
```
