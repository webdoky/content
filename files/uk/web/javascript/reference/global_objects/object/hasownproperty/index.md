...
Зверніть увагу, що цикл {{jsxref("Statements/for...in", "for...in")}} ітерує лише перелічувані елементи: відсутність неперелічуваних властивостей, виведених у циклі, не означає, що сам `hasOwnProperty` обмежений перелічуваними елементами. Ітерувати по неперелічуваних властивостях можна за допомогою {{jsxref("Object.getOwnPropertyNames()")}}.
