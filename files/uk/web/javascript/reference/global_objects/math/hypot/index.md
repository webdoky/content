...
Квадратний корінь з суми квадратів переданих аргументів. Повертає {{jsxref("Infinity")}}, якщо будь-який з аргументів – ±Infinity. Інакше, якщо принаймні один з аргументів є або зводиться до {{jsxref("NaN")}}, повертає {{jsxref("NaN")}}. Повертає `0`, якщо не передані жодні аргументи або всі аргументи ±0.
