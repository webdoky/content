...
{{InteractiveExample("Демо JavaScript: Array.forEach()")}}
...
> [!NOTE]
> Щоб показати вміст масиву у консолі, можна застосувати метод {{domxref("console/table_static", "console.table()")}}, який друкує відформатований варіант масиву.
>
...
> [!NOTE]
> Якщо передачу функції зворотного виклику було використано із застосуванням виразу
