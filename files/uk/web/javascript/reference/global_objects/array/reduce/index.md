...
Як зазначено вище, причина того, що може хотітися використовувати `reduce()`, – імітування практик функціонального програмування щодо беззмінності даних. Таким чином, розробники, які дотримуються беззмінності акумулятора, часто копіюють весь акумулятор для кожної ітерації, отак:
