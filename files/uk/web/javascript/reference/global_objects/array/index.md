...
- {{jsxref("Array.prototype.groupBy()")}} ("групувати за")
  ...
  - : Групує елементи масиву згідно з результатами перевіркової функції. До груп в результаті можна доступитись як до властивостей об‘єкта. Метод `groupBy()` групує елементи переданого масиву згідно зі значеннями, повернених перевірковою функцією. Повернений об‘єкт має окрему властивість для кожної групи, що містить масив елементів відповідної групи.
