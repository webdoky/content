...
Для копіювання масиву, необхідно фактично створити нову змінну для масиву, і по новій змінній на кожний примітивний елемент масиву (оскільки ініціалізація змінної примітивним значення справді створює копію, а не просто посилання на область у пам'яті). JavaScript надає наступні способи зробити це.

Отримання поверхневої копії за допомогою [оператора розподілу](/uk/docs/Web/JavaScript/Reference/Operators/Spread_syntax):
...
Всі ці способи дозволяють отримати _поверхневу копію_: елементи верхнього рівня копіюються, проте якщо масив містить вкладені об'єкти чи масиви, вони все ще будуть посилатись на елементи в початковому масиві.
