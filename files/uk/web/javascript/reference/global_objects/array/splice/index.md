...
Метод **`splice()`** (зростити) примірників {{jsxref("Array")}} змінює вміст масиву шляхом видалення чи заміни наявних елементів або додавання нових [на місці](https://en.wikipedia.org/wiki/In-place_algorithm).
...
Виклик `splice(0, 0, ...elements)` вставляє елементи на початку масиву, як {{jsxref("Array/unshift", "unshift()")}}.
...
Виклик `splice(array.length, 0, ...elements)` вставляє елементи в кінець масиву, як {{jsxref("Array/push", "push()")}}.
