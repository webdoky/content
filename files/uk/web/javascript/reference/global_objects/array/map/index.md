...
Оскільки `map` будує новий масив, його застосування є антипатерном у тих ситуаціях, коли повернений в результаті масив не використовується. Натомість краще використати {{jsxref("Array/forEach", "forEach")}} чи
