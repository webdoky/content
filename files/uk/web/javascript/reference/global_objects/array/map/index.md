...
Функція {{jsxref("parseInt")}} нерідко використовується з одним аргументом, але приймає два. Перший – це вираз, а другий – основа числення. `Array.prototype.map` передає три аргументи: елемент, індекс і масив. Третій аргумент ігнорується {{jsxref("parseInt")}}, але _не_ другий! Це й є джерелом можливих непорозумінь.
