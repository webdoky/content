...
- `callbackFn` не відвідає будь-які елементи, додані до масиву після того, як почався виклик методу `find`.
- Елементи, що присвоєні до вже відвіданих індексів, або ж до індексів за межами діапазону, не будуть опрацьовані `callbackFn`.
...
array.find(function(value, index) {
  ...
  // 5-й елемент все ще відвідується, хоча ми його видалили
  console.log('Visited index ', index, ' with value ', value);
});
...
- {{jsxref("Array.prototype.filter()")}} – видалити всі непідхожі елементи
