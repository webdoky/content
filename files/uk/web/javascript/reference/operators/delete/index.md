...
В наступному прикладі видаляється власна властивість об'єкта, коли властивість з таким само іменем доступна в ланцюжку прототипів:
...
Коли властивість позначена як неналаштовувана, `delete` won't have any effect, and will return `false`. In strict mode, this will raise a `TypeError`.
