...
Інший варіант: асинхронне перетворення між URL-адресами `data:` з даними Base64 можливе безпосередньо у вебплатформі за допомогою API [`FileReader`](/uk/docs/Web/API/FileReader) і [`fetch`](/uk/docs/Web/API/Fetch_API):
